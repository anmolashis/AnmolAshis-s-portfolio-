...
export const metadata: Metadata = {
  title: "ANMOL ASHIS — Full Stack Developer | Creative Engineer",
  description:
    "Award-worthy portfolio of ANMOL ASHIS — Full Stack Developer crafting premium digital experiences with React, Next.js, Three.js, and cutting-edge technology.",
  keywords: [
    "ANMOL ASHIS",
  ...
  authors: [{ name: "ANMOL ASHIS" }],
  openGraph: {
    title: "ANMOL ASHIS — Full Stack Developer",
    description:
