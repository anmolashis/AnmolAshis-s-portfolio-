    ...
    <>
      ...
      {!isLoading && (
        <StaggeredMenu
          ...
          socialItems={[
            { label: "LinkedIn", link: "https://www.linkedin.com/in/anmol-ashis1521" },
            { label: "GitHub", link: "https://github.com/anmolashis"},
            { label: "Instagram", link: "https://www.instagram.com/anmolashis_1507/?hl=en" },
          ]}
          displaySocials={true}
