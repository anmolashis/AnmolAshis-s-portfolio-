...
const SOCIAL_LINKS = [
  { label: "GitHub", href: "https://github.com/anmolashis", icon: "https://cdn.simpleicons.org/github/ffffff" },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/anmol-ashis1521", icon: "https://api.iconify.design/simple-icons:linkedin.svg?color=%23ffffff" },

  { label: "Instagram", href: "https://www.instagram.com/anmolashis_1507/?hl=en", icon: "https://cdn.simpleicons.org/instagram/ffffff" },
];
...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailtoLink = `mailto:ajinkyan550@gmail.com?subject=Portfolio Inquiry from ${formState.name}&body=${encodeURIComponent(formState.message)}`;
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white font-medium">Trabai park,kolhapur,Maharashtra</p>
                  </div>
                </div>
      ...
      >
        <div className="flex items-center justify-start text-left">
          <p className="text-xs text-ash" suppressHydrationWarning>
            © {new Date().getFullYear()} ANMOL ASHIS. Crafted with passion.
          </p>
        </div>
      </div>
    </section>
